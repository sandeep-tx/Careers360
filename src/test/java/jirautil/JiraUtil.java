...
public class JiraUtil {
     ...
     * <br>
     *
     * @param projectKey     - Specify the project key generated while creating the
     *                       project. <br>
     *                       <br>
     * @param summary        - Specify the summary to be added to the new bug. <br>
     *                       <br>
     * @param description    - Specify the description to be added to the new bug. <br>
     *                       <br>
     * @param reporter       - Specify the reporter to be added to the new bug. See the username from the User Management page.<br>
     *                       <br>
     * @param assignee       - Specify the assignee to be added to the new bug. See the username from the User Management page.<br>
     *                       <br>
     * @param attachmentPath - Specify the path of the attachment to be added to the new bug. The name of the attachment is same as the original name of the image.<br>
     *                       <br>
     * @throws Exception If incorrect browser name entered. <br>
     *                   <br>
     * @version 1.0 <br>
     * <br>
    ...
    public void updateJiraTestResults(String ExecutionID, String Comments, String Result) {
        try {
            ...
            //creating the Rest object to pass through REST API for Updating the testcase Result
